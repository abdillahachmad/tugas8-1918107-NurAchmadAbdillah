...
import com.example.cekongkir.adapter.CityAdapter;
import com.example.cekongkir.adapter.ExpedisiAdapter;
import com.example.cekongkir.adapter.ProvinceAdapter;
import com.example.cekongkir.api.ApiService;
import com.example.cekongkir.api.ApiUrl;
import com.example.cekongkir.model.city.ItemCity;
import com.example.cekongkir.model.cost.ItemCost;
import com.example.cekongkir.model.expedisi.ItemExpedisi;
import com.example.cekongkir.model.province.ItemProvince;
import com.example.cekongkir.model.province.Result;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<com.example.cekongkir.model.city.Result> ListCity = new ArrayList<com.example.cekongkir.model.city.Result>();
    ...
    public void popUpCity(final EditText etCity, final EditText etProvince) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Object o = mListView.getItemAtPosition(i);
                com.example.cekongkir.model.city.Result cn = (com.example.cekongkir.model.city.Result) o;
        ...
        call.enqueue(new Callback<ItemCity>() {
            ...
            public void onResponse(Call<ItemCity> call, Response<ItemCity> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    int count_data = response.body().getRajaongkir().getResults().size();
                    for (int a = 0; a <= count_data - 1; a++) {
                        com.example.cekongkir.model.city.Result itemProvince = new com.example.cekongkir.model.city.Result(
